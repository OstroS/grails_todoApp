...
class TaskController {
	...
	def scaffold = Task
	TasksService tasksService // convention over configuration - instance is injected
	
	def list(User userInstance) {
		def listOfUserTasks = tasksService.listUserTasks(userInstance);
		print "List of user tasks:"
		listOfUserTasks.each(task) { print task + "\n" }; // TODO
	}
